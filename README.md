...
- **Evolução**: as 4 perícias (os bônus são aplicados na Ficha automaticamente) com os benefícios acumulados, talentos de perícia, upgrades de clã, calculadora de pontos de treino e registro de treinos, escalonamento com o nível atual destacado.
...
- **Atributos**: `−1 + clã + pontos distribuídos + classe + perícias`. O custo da distribuição segue a tabela da criação (passar de 1 para 2 custa 2).
